...
// Person.find({height: {$gt: 180}, salary: {$gt: 30000}}, function(err, person){
//   console.log(person)
// })


//2. Find all the people who are tall (>180) OR rich (>30000)
// Person.find({$or: [{height: {$gt: 300}}, {salary: {$gt: 30000}}]}, function(err, person){
//   console.log(person)
// })
...
//   })
//   .exec(function(err, persons){
//     persons.forEach(p => console.log(p.kids))
...
//   })
//   .exec(function(err, persons){            
//     persons.forEach(p =>  console.log(`parent: ${p.weight}`))
//     persons.forEach(p => p.kids.forEach(r => console.log(`kid: ${r.weight}`)) )
//   })
